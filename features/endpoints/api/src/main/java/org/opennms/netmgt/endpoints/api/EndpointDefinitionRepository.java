...
public interface EndpointDefinitionRepository {
    ...
    EndpointDefinition get(String endpointUid) throws NoSuchElementException;

    EndpointDefinition get(long endpointId) throws NoSuchElementException;

    EndpointDefinition saveOrUpdate(EndpointDefinition endpointDefinition);

    boolean delete(EndpointDefinition endpointDefinition) throws NoSuchElementException;
}
